...
const TopPlace = () => {
    return (
        <div className="my-20 max-w-[1600px] mx-auto ">
            <h1 className="text-center text-4xl font-bold" data-aos="fade-in">Our Next Locations </h1>
            <p className="text-base text-center mt-2 mb-10">Discover diverse escapes with Crestiq Vibe. Find your perfect retreat today.</p>
            <div className="grid grid-col-1 md:grid-cols-2 xl:grid-cols-3 gap-5 p-8">
                <div className="relative max-h-[300px]" data-aos="fade-down-right">
                ...
                <div className="relative max-h-[300px]" data-aos="fade-down">
                ...
                <div className="relative max-h-[300px]" data-aos="fade-down-left">
                ...
                <div className="relative max-h-[300px]" data-aos="fade-up-right">
                ...
                <div className="relative max-h-[300px]" data-aos="fade-up">
                ...
                <div className="relative max-h-[300px]" data-aos="fade-up-left">
